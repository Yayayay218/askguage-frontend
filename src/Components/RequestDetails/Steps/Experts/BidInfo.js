...
// const BidInfo = ({item, onChange, myBid, isBid}) => {
//     const bind = (field) => ({
//         onChange: (e) => onChange({...myBid, callback: {...myBid['callback'], [field]: e.target.value}})
//     })
//
//     function doBid(item, myBid) {
//         let data = {
//             ...myBid,
//             status: 2
//         }
//         axios.patch(Config.URL + `/bids/${item.id}`, data)
//             .then((res) => isBid({isBid: true}))
//     }
//
...
//                             <CallBackActions
//                                 disabled={myBid.callback.availableDate === '' || myBid.callback.availableTime === ''}
//                                 doBid={doBid.bind(this, item, myBid)}
//                                 doReject={doReject.bind(this, item, myBid)}
//                             />
//                         </div>
//                     }
//
